...
//#include "include/api_thirdperson" // Thirdperson is actually just ripped from the engine module with some small modifications
#include <engine>
...
{
	RegisterPlugin()
	register_concmd("sw_thirdperson", "Thirdperson")
}
