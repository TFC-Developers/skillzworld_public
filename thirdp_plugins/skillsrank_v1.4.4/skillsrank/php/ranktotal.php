...
$query="SELECT `steamId`, `nickNames`, `nFinnished`, `rankTotal`, `primaryRank` FROM `skillrank` ORDER BY ABS(rankTotal) DESC";
...
<font face=verdana size=2>Ordered by most collected points</center></font><br>
<center><font face=verdana size=2>
Sort by <a href=index.php>Nickname</a> | <a href=nfinished.php>Finished times</a> | <a href=primaryrank.php>Average Difficulty</a>
