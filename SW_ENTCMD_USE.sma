...
public use_entity(id) {
    ...
    new Float:vecOrigin[3], Float:absMin[3], Float:absMax[3], Float:vecDest[3];
    vecOrigin = {0.0, 0.0, 0.0};
    ...
    broadcast_beam(id, vecDest);
    return PLUGIN_CONTINUE;
}

stock broadcast_beam(id, Float:vecOrigin[3]) {
    console_print(0, "broadcasting beam: %f %f %f ", vecOrigin[0], vecOrigin[1], vecOrigin[2]);
